package gradingTools.comp999.assignment1.testcases.autoproxyreference;

import grader.basics.junit.BasicJUnitUtils;
import grader.basics.junit.GradableJUnitSuite;
import grader.basics.junit.GradableTreeConstructionResult;
import grader.basics.project.BasicProject;
import grader.basics.project.CurrentProjectHolder;
import gradingTools.comp999.assignment1.testcases.multi.MultiPointAngleSuite;
import gradingTools.comp999.assignment1.testcases.multi.MultiPointPrintTest;
import gradingTools.comp999.assignment1.testcases.multi.MultiPointProxyFactory;
import gradingTools.comp999.assignment1.testcases.multi.MultiPointRadiusTest;
import gradingTools.comp999.assignment1.testcases.multi.MultiPointTranslationTest;
import gradingTools.comp999.assignment1.testcases.reflection.AReflectivePointMainTest;
...
//		CurrentProjectHolder.setProject(new BasicProject(null, new File("."), null, "allcorrect"));
		GradableJUnitSuite aGradable = BasicJUnitUtils.toGradableTree(AutoProxyCartesianPointSuite.class).rootNode;
//		GradableTreeConstructionResult aGradable = BasicJUnitUtils.toGradableTree(AutoProxyCartesianPointSuite.class);
